...
export default () => (
  <FAQ>
    ...
    <Item
      ...
      она выглядит как <b>"wget -E -H -k -K -Q10M http://site.com"</b>:
      <Ul>
        <li>Параметр <b>-E</b> сохранит файлы с mime-type application/xhtml+xml или text/html с расширением .html, нужно в случае выкачивания динамических сайтов с расширениями .php или .asp.
        </li>
        <li>Параметр <b>-k</b> укажет программе преобразовать все ссылки на ресурсы, чтобы их можно
          было использовать на компьютере.
        </li>
        <li>Параметр <b>-K</b> конвертировать ссылки обратно, убирать расширение .orig, изменяет поведение опции -N.
        </li>
        <li>Параметр <b>-H</b> разрешает переходить на любые доменные имена на которые будут указывать ссылки.
        </li>
